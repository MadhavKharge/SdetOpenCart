...
public class ExcelUtility {
	...
	public int getCellCount(String sheetname, int rounum) throws IOException {
	...
	public String getCellData(String sheetname, int rownum, int colnum) throws IOException {
		...
		try {
			data = formatter.formatCellValue(cell);// return the formatted value of cell as a string regardsless
		} catch (Exception e) {
			data = "";
		}
	...
	public void setCellData(String sheetname, int rownum, int column, String data) throws IOException {
		...
		if (sheet.getRow(rownum) == null) // if row not exists create new rpw
